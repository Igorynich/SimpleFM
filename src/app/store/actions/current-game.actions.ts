...
export const addGoalScorersForMatch = createAction('Adds goal scorers to match stats', props<{matchId: number,
  goals: {homeGoals: {[minute: number]: Player}, awayGoals: {[minute: number]: Player}}}>());
